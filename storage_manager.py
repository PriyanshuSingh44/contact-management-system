...
In Docker, the CONTACTS_FILE env var overrides the default path so
the file is written into the named volume (/app/data/contacts.json).
"""
...
class StorageManager:
    ...
    def __init__(
        ...
        elif os.environ.get("CONTACTS_FILE"):
            # Docker: use the explicit path from the environment variable
            self._filepath = Path(os.environ["CONTACTS_FILE"])
        else:
